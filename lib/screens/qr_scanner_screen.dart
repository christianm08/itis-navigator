...
class QrPoint {
  ...
  final double lat;
  final double lng;
  const QrPoint({required this.label, required this.password, required this.lat, required this.lng});
...
class _QrCameraPageState extends State<_QrCameraPage> with WidgetsBindingObserver {
