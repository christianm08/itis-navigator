...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _openSchoolWebsite() async {
    ...
    if (!ok && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('Impossibile aprire il sito della scuola')),
      );
    }
  }
  ...
  void _openDestinationPicker() {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (_) => const DestinationPickerScreen()),
    );
  }
      ...
      builder: (context, ws, _) => Container(
        ...
        child: ws.isLoading
            ...
            : LayoutBuilder(builder: (context, constraints) {
                ...
                return Semantics(
                  label:
                      'Meteo a Cassino: ${ws.description}, ${ws.temperature} gradi. '
                          ...
                          children: [
                            ...
                            Wrap(
                              ...
                              children: [
                                ...
                                _buildWeatherDetail(theme, 'Umidità',
                                    '${ws.humidity}%'),
                              ],
                            ),
                          ],
  ...
  Widget _buildNavigationCard(ThemeData theme) {
    return Semantics(
      button: true,
      label: 'Inizia navigazione. Tocca per scegliere la destinazione all\'ITIS.',
      child: Container(
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.circular(28),
